...
const Register = () => {
    ...
    return (
        <div className="flex justify-center">
            <form onSubmit={handleRegister} className="bg-zinc-300 dark:bg-zinc-700  p-8 rounded-xl flex flex-col gap-4 max-w-xs">
                ...
                <button type="submit" className="bg-blue-500 px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-1 dark:focus:outline-zinc-100 focus:outline-zinc-700 hover:cursor-pointer transition delay-200 ease-in mt-4">Register</button>

                <p className="mt-4 text-sm">Already have an account? <Link to="/login" className="text-blue-500 hover:text-rose-500 outline-none focus:text-rose-500">Login</Link></p>
            </form>
        </div>
    )
}
