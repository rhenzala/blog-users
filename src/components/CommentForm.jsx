  ...
  return (
    <div className=" my-4 py-4">
      <form onSubmit={handleCreateComment} className="flex gap-2">
        ...
        <button
          type="submit"
          className="bg-blue-500 text-sm px-2 py-1 rounded-md hover:bg-blue-600 focus:outline-1 dark:focus:outline-zinc-100 focus:outline-zinc-700 hover:cursor-pointer transition delay-200 ease-in w-fit h-fit self-end"
        >
          SEND
        </button>
      </form>
